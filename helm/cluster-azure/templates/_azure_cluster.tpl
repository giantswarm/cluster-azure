  ...
  networkSpec:
    subnets:
      - name: {{ include "network.subnets.controlPlane.name" $ }}
        ...
        {{- include "network.subnet.privateEndpoints" .Values.connectivity.network.controlPlane.privateEndpoints | nindent 8 -}}
        securityGroup:
      ...
      - name: {{ include "network.subnets.nodes.name" $ }}
        ...
        role: node
        {{- include "network.subnet.privateEndpoints" .Values.connectivity.network.workers.privateEndpoints | nindent 8 -}}
        cidrBlocks:
