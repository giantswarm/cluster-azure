...
| `global.apps.azureCloudControllerManager.extraConfigs[*].kind` | **Kind** - Specifies whether the resource is a config map or a secret.|**Type:** `string`<br/>**Allowed values:** `ConfigMap`, `Secret`<br/>|
...
| `global.apps.azureCloudNodeManager.extraConfigs[*].kind` | **Kind** - Specifies whether the resource is a config map or a secret.|**Type:** `string`<br/>**Allowed values:** `ConfigMap`, `Secret`<br/>|
...
| `global.apps.azureDiskCsiDriver.extraConfigs[*].kind` | **Kind** - Specifies whether the resource is a config map or a secret.|**Type:** `string`<br/>**Allowed values:** `ConfigMap`, `Secret`<br/>|
...
| `global.apps.azureFileCsiDriver.extraConfigs[*].kind` | **Kind** - Specifies whether the resource is a config map or a secret.|**Type:** `string`<br/>**Allowed values:** `configMap`, `secret`<br/>|
...
| `global.apps.externalDnsPrivate.extraConfigs[*].kind` | **Kind** - Specifies whether the resource is a config map or a secret.|**Type:** `string`<br/>**Allowed values:** `configMap`, `secret`<br/>|
...
| `global.apps.kamajiEtcd` | **App** - Configuration of an default app that is part of the cluster.|**Type:** `object`<br/>|
...
| `global.apps.priorityClasses` | **App** - Configuration of an default app that is part of the cluster.|**Type:** `object`<br/>|
...
| `global.connectivity.network.name` | **Virtual network name (BYON)**|**Type:** `string`<br/>|
...
| `global.connectivity.network.resourceGroupName` | **Virtual network resource group name (BYON)**|**Type:** `string`<br/>|
